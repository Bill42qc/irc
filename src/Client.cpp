...
Client::Client(int clientSocket): hostName_(""),nickName_(""),userName_(""),clientSocket_(clientSocket), hasPassword_(false), hasCapLs_(false), hasNick_(false), hasUser_(false), isAuth_(false), authSent_(false){
}
