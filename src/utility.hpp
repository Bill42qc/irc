...
/**
	...
	* registration (such as resending the PASS or USER after registration).
...
/**
	...
	* The text used in the last param of this message may vary.
*/
#define ERR_NOSUCHCHANNEL (client, channel) client << channel << " :No such channel" << CRLF
/**
	* ERR_TOOMANYCHANNELS (405)
	* Indicates that the JOIN command failed because the client has joined their maximum number of channels.
	* The text used in the last param of this message may vary.
*/
#define ERR_TOOMANYCHANNELS (client, channel) client << channel << " :You have joined too many channels" << CRLF
/**
	...
	* The text used in the last param of this message may vary.
*/
#define ERR_BADCHANNELKEY (client, channel) client << channel << " :Cannot join channel (+k)" << CRLF
/**
	...
	* The text used in the last param of this message may vary.
*/
#define ERR_BANNEDFROMCHAN (client, channel) client << channel << " :Cannot join channel (+b)" << CRLF
/**
	...
	* The text used in the last param of this message may vary.
*/
#define ERR_CHANNELISFULL (client, channel) client << channel << " :Cannot join channel (+l)" << CRLF
/**
	...
	* The text used in the last param of this message may vary.
*/
#define ERR_INVITEONLYCHAN (client, channel) client << channel << " :Cannot join channel (+i)" << CRLF
/**
	* ERR_BADCHANMASK (476)
	...
	* The text used in the last param of this message may vary.
*/
#define ERR_BADCHANMASK (channel) channel << " :Bad Channel Mask" << CRLF
/**
	* RPL_TOPIC (332)
...
*/
#define RPL_TOPICWHOTIME (client, channel, nick, setat) client << channel << nick << setat << CRLF
/**
	* RPL_NAMREPLY (353)
